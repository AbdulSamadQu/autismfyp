...
import 'package:autismx/screens/surveys/surveyes_screens/adolescent/continue.dart';
import 'package:autismx/screens/surveys/surveyes_screens/adolescent/result_screen.dart';
                        ...
                        Center(
                          child: SizedBox(
                            ...
                            child: FAProgressBar(
                              ...
                              maxValue: 100,
                              currentValue:
                                  (questionIndex * 100 / questions.length).toDouble(),
                              progressColor: Colors.blue,
                              border: Border.all(
                                color: Colors.grey,
                                width: 0.1,
                ...
                child: Stack(children: [
                  Positioned(
                    ...
                    child: Container(
                        ...
                        height: MediaQuery.of(context).size.height * 0.35,
                        child:
                            Image.asset("assets/images/Communicationopa.png")),
                  ),
                  Card(
                    child: Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                ...
                child: 
                  ...
                  Positioned(
                    ...
                    child: Container(
                        width: MediaQuery.of(context).size.width,
                        height: MediaQuery.of(context).size.height * 0.35,
                        child: Image.asset("assets/images/Imaginationopa.png")),
                  ), Column(
                      mainAxisAlignment: MainAxisAlignment.start,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: <Widget>[
